...
# ==================== DeepSeek 解读 ====================
def get_deepseek_interpretation(report_text, recent_state_dist=None, recent_signals=None):
...
if __name__ == "__main__":
    ...
    if ds_client:
        interp, score = get_deepseek_interpretation(base_report, state_dist, recent_signals)
